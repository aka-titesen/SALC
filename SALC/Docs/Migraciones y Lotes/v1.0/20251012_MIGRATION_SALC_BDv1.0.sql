...
--    en la tabla 'estados_analisis' (ej: 'Anulado').
----------------------------------------------------------------------
...
CREATE TABLE estados_analisis (
    ...
    -- NOTA: Para anular un análisis, se debe agregar un estado 'Anulado' aquí.
);
...
CREATE TABLE obras_sociales (
    ...
    estado         NVARCHAR(20) NOT NULL DEFAULT 'Activo', -- BAJA LÓGICA
...
CREATE TABLE usuarios (
    ...
    id_rol          INT NOT NULL,
    estado          NVARCHAR(20) NOT NULL, -- BAJA LÓGICA YA IMPLEMENTADA
...
-----------------------------------------------------------
-- (No se agrega baja lógica aquí, se maneja con estados en 'estados_analisis')
-- 5.1 ANALISIS
