...
namespace SALC.Views
{
    ...
    public partial class DetalleAnalisisForm : Form
    {
        ...
        private ReporteAnalisis _reporteAnalisis;
        ...
        public DetalleAnalisisForm(ReporteAnalisis reporteAnalisis, List<ResultadoAnalisis> resultadosAnalisis)
        {
            _servicioReportes = new ServicioReportesAnalisis();
            _reporteAnalisis = reporteAnalisis;
        ...
        private void CargarDatosAnalisis()
        {
            ...
            AgregarInfoAPanel(panelInfoPaciente, "DNI:", _reporteAnalisis.IdPaciente);
            AgregarInfoAPanel(panelInfoPaciente, "Nombre:", _reporteAnalisis.NombrePaciente);
            AgregarInfoAPanel(panelInfoPaciente, "Obra Social:", _reporteAnalisis.ObraSocial ?? "Sin obra social");
            AgregarInfoAPanel(panelInfoPaciente, "Teléfono:", _reporteAnalisis.TelefonoPaciente ?? "No disponible");

            // Cargar datos del análisis
            AgregarInfoAPanel(panelInfoAnalisis, "ID Análisis:", _reporteAnalisis.IdReporte.ToString());
            AgregarInfoAPanel(panelInfoAnalisis, "Tipo de Análisis:", _reporteAnalisis.TipoAnalisis);
            AgregarInfoAPanel(panelInfoAnalisis, "Estado:", _reporteAnalisis.Estado);
            AgregarInfoAPanel(panelInfoAnalisis, "Fecha Creación:", _reporteAnalisis.FechaAnalisis.ToString("dd/MM/yyyy HH:mm"));
            AgregarInfoAPanel(panelInfoAnalisis, "Médico:", _reporteAnalisis.NombreMedico);
            AgregarInfoAPanel(panelInfoAnalisis, "Observaciones:", _reporteAnalisis.Observaciones ?? "Sin observaciones");
        ...
        private void BtnExportarPdf_Click(object sender, EventArgs e)
        {
            try
            {
                _servicioReportes.ExportarAPdf(_reporteAnalisis);
