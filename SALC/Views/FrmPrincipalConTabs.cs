...
namespace SALC.Views
{
    public class FrmPrincipalConTabs : Form
    {
        ...
        private void AgregarPestanasAdministrador()
        {
            ...
            {
                Text = "Panel de Administración de Usuarios\n\nFuncionalidades:\n• Crear usuarios (Médicos y Asistentes)\n• Modificar información de usuarios\n• Gestionar estados de usuarios\n• Asignar roles y permisos",
            ...
            {
                Text = "Panel de Administración de Catálogos\n\nFuncionalidades:\n• Gestionar tipos de análisis\n• Administrar métricas de laboratorio\n• Configurar obras sociales\n• Mantener parámetros del sistema",
                Font = new Font("Segoe UI", 12),
                ForeColor = Color.FromArgb(70, 130, 180),
                TextAlign = ContentAlignment.MiddleCenter,
                Dock = DockStyle.Fill
            ...
            {
                Text = "Panel de Gestión de Copias de Seguridad\n\nFuncionalidades:\n• Crear copias de seguridad\n• Programar backups automáticos\n• Restaurar base de datos\n• Verificar integridad de datos",
                Font = new Font("Segoe UI", 12),
                ForeColor = Color.FromArgb(70, 130, 180),
                TextAlign = ContentAlignment.MiddleCenter,
                Dock = DockStyle.Fill
