...
{
    /// <summary>
    /// Formulario para agregar nuevos an�lisis al sistema
    /// Implementa RF-05: Crear An�lisis seg�n ERS v2.7
    /// </summary>
    ...
    private readonly PacienteService _pacienteService;
        ...
        private void CargarTiposAnalisis()
        {
            ...
            cmbTipoAnalisis.Items.Add(new ElementoComboBox("Seleccionar tipo de an�lisis...", 0));
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidarDatos())
                {
                    ...
                    if (exito)
                    {
                        MessageBox.Show("An�lisis creado exitosamente.", "�xito",
                    ...
                    {
                        MessageBox.Show("Error al crear el an�lisis.", "Error",
                            MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
        ...
        private bool ValidarDatos()
        {
            ...
            {
                MessageBox.Show("Debe seleccionar un paciente.", "Validaci�n",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                cmbPaciente.Focus();
                return false;
            }

            // Validar tipo de an�lisis seleccionado
            if (cmbTipoAnalisis.SelectedIndex <= 0)
            {
                MessageBox.Show("Debe seleccionar un tipo de an�lisis.", "Validaci�n",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
