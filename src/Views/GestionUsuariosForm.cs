...
namespace SALC.Views
{
    ...
    public partial class GestionUsuariosForm : Form
    {
        ...
        private void CargarUsuarios(string filtroNombre = "", string filtroRol = "")
        {
            try
            {
                // Convertir "Todos los roles" a cadena vac�a para el servicio
        ...
        private void BtnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Crear y configurar el di�logo para creaci�n
                ...
                if (dialogo.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("Usuario creado exitosamente.", "�xito",
        ...
        private void BtnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Por favor, seleccione un usuario para editar.", "Selecci�n requerida",
            ...
            try
            {
                ...
                if (usuario == null)
                {
                    MessageBox.Show("No se encontr� el usuario seleccionado.", "Error",
                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                // Crear y configurar el di�logo para edici�n
                var dialogo = new DialogoFormularioUsuario();
                ...
                if (dialogo.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("Usuario actualizado exitosamente.", "�xito",
                        MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void BtnDesactivar_Click(object sender, EventArgs e)
        {
            if (dataGridViewUsuarios.SelectedRows.Count == 0)
            {
                MessageBox.Show("Por favor, seleccione un usuario para desactivar.", "Selecci�n requerida",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            var resultado = MessageBox.Show(
                $"�Est� seguro que desea desactivar al usuario {nombre} {apellido} (DNI: {dni})?",
            ...
            if (resultado == DialogResult.Yes)
            {
                try
                {
                    ...
                    if (exito)
                        MessageBox.Show("Usuario desactivado correctamente.", "�xito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    else
        ...
        private void BtnActivar_Click(object sender, EventArgs e)
        {
            if (dataGridViewUsuarios.SelectedRows.Count == 0)
            {
                MessageBox.Show("Por favor, seleccione un usuario para activar.", "Selecci�n requerida",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            var resultado = MessageBox.Show(
                $"�Est� seguro que desea activar al usuario {nombre} {apellido} (DNI: {dni})?",
            ...
            if (resultado == DialogResult.Yes)
            {
                try
                {
                    ...
                    if (exito)
                        MessageBox.Show("Usuario activado correctamente.", "�xito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    else
